...
$items_per_page = 10; // Sesuaikan dengan jumlah item per halaman yang diinginkan
$total_items_query = "SELECT COUNT(*) as total FROM barang_masuk";
...
// Mengambil data barang masuk dengan pagination
      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            <div class="container">
        <h1 class="text-lg leading-3 font-medium text-gray-900 dark:text-gray-200">Tambah Barang Masuk</h1>
        ...
        <h1 class="text-lg leading-3 font-medium text-gray-900 dark:text-gray-200 mt-8">Daftar Barang</h1>
        ...
        <table class="min-w-full w-full bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          <thead class="bg-gray-800">
            <tr>
                ...
                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 dark:text-gray-200 uppercase tracking-wider">Tanggal Masuk</th>
            </tr>
      ...
      <tbody>
        ...
        if (mysqli_num_rows($result_masuk) > 0) {
          while ($row = mysqli_fetch_assoc($result_masuk)) {
            echo "<tr>
                    <td class='px-6 py-4 whitespace-nowrap text-sm text-gray-300 dark:text-gray-200'>" . $row['id_masuk'] . "</td>
                    <td class='px-6 py-4 whitespace-nowrap text-sm text-gray-300 dark:text-gray-200'>" . $row['nama_barang'] . "</td>
                    <td class='px-6 py-4 whitespace-nowrap text-sm text-gray-300 dark:text-gray-200'>" . $row['jumlah_masuk'] . "</td>
                    <td class='px-6 py-4 whitespace-nowrap text-sm text-gray-300 dark:text-gray-200'>" . $row['tanggal_masuk'] . "</td>
                  </tr>";
          }
        } else {
          echo "<tr><td colspan='4' class='py-3 px-6 text-center'>Tidak ada data barang masuk</td></tr>";
        }
        ?>
      </tbody>
    </table>
      ...
      <ul class="pagination">
        <?php for ($i = 1; $i <= $total_pages; $i++) { ?>
          <li class="page-item <?php if ($i == $page) echo 'active'; ?>">
            <a class="page-link" href="barang_masuk.php?page=<?= $i; ?>"><?= $i; ?></a>
          </li>
        <?php } ?>
      </ul>
    </nav>
