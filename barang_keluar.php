            ...
            <tbody>
                ...
                if (mysqli_num_rows($result_keluar) > 0) {
                    while ($row = mysqli_fetch_assoc($result_keluar)) {
                        echo "<tr>
                                <td class='px-6 py-4 whitespace-nowrap text-sm text-gray-300 dark:text-gray-200'>" . $row['id_keluar'] . "</td>
                                <td class='px-6 py-4 whitespace-nowrap text-sm text-gray-300 dark:text-gray-200'>" . $row['nama_barang'] . "</td>
                                <td class='px-6 py-4 whitespace-nowrap text-sm text-gray-300 dark:text-gray-200'>" . $row['jumlah_keluar'] . "</td>
